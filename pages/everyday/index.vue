	...
	<div v-else class="skeleton-wrap">
		<el-skeleton :key="item" animated class="skeleton-wrap__item">
			<template #template>
				...
				<el-skeleton-item variant="image" style="width: 880px; height: 495px" />
				<el-skeleton-item variant="p" class="mt-[10px] mb-[10px]" style="height: 34px; width: 200px; display: flex" />
				<el-skeleton-item variant="p" style="height: 34px" />
			</template>
		</el-skeleton>
	</div>
